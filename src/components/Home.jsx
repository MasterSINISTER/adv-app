  ...
  return (
    <>
        ...
        <div className="modal">
          <div className="modal-content">
            ...
            <p>
              ...
              to solicit work and advertise. By visiting the website, the user
              acknowledges that the information provided on this website is
              solely available for informational purposes only sought to be
              voluntarily gained by him/her and is neither soliciting nor
              advertisement. Further, the information provided on this website
              is accessed by the user’s own volition, and any transmission,
              receipt or use of this information available on this website does
        ...
        <div className="video-container">
          ...
          <div className="heading-container">
            <div>
              ...
              <button className="btn-explore" onClick={handleServicesScroll}>
                Explore Now !
              </button>
            </div>
          </div>
      ...
      <section className="about-us">
        <h1 className="firstSection-heading">Legal Assistance at Right Time</h1>
        ...
        <div className="firstSection-container">
          <div className="para-container">
            ...
            >
              ...
              areas. */}
              Legal assistance at the right time can protect your rights,
              prevent complications, and ensure fair outcomes. Whether it's a
              criminal case, civil dispute, business matter, or employment
              issue, timely legal guidance can save you from unnecessary stress
              and financial loss. Consulting a lawyer before signing contracts,
              handling disputes, or facing legal action helps you stay compliant
              with the law and make informed decisions. From protecting
              businesses to defending individuals, professional legal support
              ensures justice and peace of mind. Don't wait for problems to
              escalate—seek legal help when you need it the most.
              <br></br>
              <br></br>
              <br></br>
            </motion.p>
      ...
      <section className="our-services">
        ...
        <div style={{ marginTop: "10%" }}>
          <div
            className="tes-cards-container"
            data-aos="slide-right"
            delay={1000}
          >
            <div className="tes-card">
              <img
                src="https://assets-v2.lottiefiles.com/a/72d1e8f4-1169-11ee-be4e-f75a6faac104/K5i1Cfk8j5.gif"
                alt=""
              ...
              <Rating
                ...
                sx={{ color: "white" }}
              />
              <h2 className="tes-heading">Akanksha</h2>
            ...
            <div className="tes-card">
              <img
                src="https://assets-v2.lottiefiles.com/a/82411e66-1184-11ee-8cfa-d707e53cae38/bccvxj7Ogv.gif"
                alt=""
              />
              <br></br>
              <br></br>
              <Rating
                ...
                sx={{ color: "white" }}
              />
              <h2 className="tes-heading">Nitin</h2>
              <h3 className="tes-content">
            ...
            <div className="tes-card">
              <img
                src="https://cdn.dribbble.com/users/456158/screenshots/6305721/care-bot.gif"
                alt=""
              />
              <br></br>
              <br></br>
              <Rating
                ...
                sx={{ color: "white" }}
              />
              <h2 className="tes-heading">Anindita</h2>
              <h3 className="tes-content">
                Thanks for recommending Advocate Gupta. A genuine expert, with
                impressive knowledge and experience. He helped us solve our
                problem in a warm and unassuming manner.{" "}
              </h3>
            </div>
          </div>
